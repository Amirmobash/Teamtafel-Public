...
namespace ManagementApp
{
    public partial class App : System.Windows.Application
    {
        ...
        private static readonly DateTime ExpireUtc = new DateTime(2026, 7, 7, 0, 0, 0, DateTimeKind.Utc);

        private static string CalibrationFlagPath =>
            Path.Combine(
        ...
        {
            if (DateTime.UtcNow >= ExpireUtc && !File.Exists(CalibrationFlagPath))
            {
                Shutdown(0);
                return;
            }
